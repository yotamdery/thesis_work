...
# Activity vector
with open(MAIN_DIR + '/Data/parameters/visitors_covid.pickle', 'rb') as pickle_in:
...
#events_dict['school_opening_5'] = ['2021-09-01', '2021-09-26']
...
v3_efficiency = 0.8				# Initialization. We want to control this variable when simulating the results, Hence the difference from the previous two transitions.
