...
def get_vaccination_pq(curr_res_mdl_1_ml: dict, model_1_ml_):
    ...
    vaccination_que = {}
    reported_unreported = get_reported_unreported_ratio('Scenario4')
...
def calc_trans_prop(vaccination_pq: list, curr_res_mdl_1_ml: dict, curr_inv_: float):
    # Initializing the accumulated amount used and the priority queue:
    curr_inventory_used = 0
    vaccination_pq_copy = vaccination_pq.copy()
...
#     model_1_ml = defining_model('Scenario4')
